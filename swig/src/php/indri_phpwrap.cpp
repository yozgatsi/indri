...
ZEND_NAMED_FUNCTION(_wrap_TermExtent_begin_set) {
  ...
  /*@SWIG:/home/tavit/usr/share/swig/3.0.12/php5/utils.i,7,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_Parameters_get_bool) {
  ...
  /*@SWIG:/home/tavit/usr/share/swig/3.0.12/php5/utils.i,2,CONVERT_BOOL_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_Parameters_get_double) {
  ...
  /*@SWIG:/home/tavit/usr/share/swig/3.0.12/php5/utils.i,52,CONVERT_FLOAT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_QueryEnvironment_expressionCount) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_QueryEnvironment_expressionCount__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          _wrap_QueryEnvironment_expressionCount__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
        }
      }
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_QueryEnvironment_documentExpressionCount) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_QueryEnvironment_documentExpressionCount__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          _wrap_QueryEnvironment_documentExpressionCount__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
        }
      }
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_QueryEnvironment_expressionList) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_QueryEnvironment_expressionList__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          _wrap_QueryEnvironment_expressionList__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
        }
      }
    }
  }
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          _wrap_QueryExpander_runExpandedQuery__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            _wrap_QueryExpander_runExpandedQuery__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
          }
        }
      }
    }
...
static zend_function_entry libindri_php_functions[] = {
 SWIG_ZEND_NAMED_FE(termextent_begin_set,_wrap_TermExtent_begin_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(termextent_begin_get,_wrap_TermExtent_begin_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(termextent_end_set,_wrap_TermExtent_end_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(termextent_end_get,_wrap_TermExtent_end_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(new_termextent,_wrap_new_TermExtent,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(new_parameters,_wrap_new_Parameters,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(parameters_set,_wrap_Parameters_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(parameters_get_bool,_wrap_Parameters_get_bool,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_get_int,_wrap_Parameters_get_int,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_get_double,_wrap_Parameters_get_double,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_get_int64,_wrap_Parameters_get_INT64,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_get_string,_wrap_Parameters_get_string,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_remove,_wrap_Parameters_remove,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(parameters_set_bool,_wrap_Parameters_set_bool,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_set_string,_wrap_Parameters_set_string,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_set_int,_wrap_Parameters_set_int,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_set_uint64,_wrap_Parameters_set_UINT64,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_set_double,_wrap_Parameters_set_double,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(parameters_clear,_wrap_Parameters_clear,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(parameters_size,_wrap_Parameters_size,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(parameters_exists,_wrap_Parameters_exists,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(parameters_load,_wrap_Parameters_load,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(new_scoredextentresult,_wrap_new_ScoredExtentResult,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(parseddocument_getcontent,_wrap_ParsedDocument_getContent,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(new_parseddocument,_wrap_new_ParsedDocument,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(new_queryannotationnode,_wrap_new_QueryAnnotationNode,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(queryannotation_getquerytree,_wrap_QueryAnnotation_getQueryTree,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryannotation_getannotations,_wrap_QueryAnnotation_getAnnotations,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryannotation_getresults,_wrap_QueryAnnotation_getResults,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryenvironment_addserver,_wrap_QueryEnvironment_addServer,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_addindex,_wrap_QueryEnvironment_addIndex,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_close,_wrap_QueryEnvironment_close,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryenvironment_setmemory,_wrap_QueryEnvironment_setMemory,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_setscoringrules,_wrap_QueryEnvironment_setScoringRules,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_setstopwords,_wrap_QueryEnvironment_setStopwords,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_runquery,_wrap_QueryEnvironment_runQuery,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_runquerydocset,_wrap_QueryEnvironment_runQuerydocset,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(queryenvironment_runannotatedquery,_wrap_QueryEnvironment_runAnnotatedQuery,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_runannotatedquerydocset,_wrap_QueryEnvironment_runAnnotatedQuerydocset,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentsdocids,_wrap_QueryEnvironment_documentsdocids,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_documents,_wrap_QueryEnvironment_documents,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentmetadatadocids,_wrap_QueryEnvironment_documentMetadatadocids,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentmetadata,_wrap_QueryEnvironment_documentMetadata,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentidsfrommetadata,_wrap_QueryEnvironment_documentIDsFromMetadata,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_termcount,_wrap_QueryEnvironment_termCount,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryenvironment_onetermcount,_wrap_QueryEnvironment_onetermCount,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_stemcount,_wrap_QueryEnvironment_stemCount,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_termfieldcount,_wrap_QueryEnvironment_termFieldCount,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_stemfieldcount,_wrap_QueryEnvironment_stemFieldCount,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryenvironment_fieldlist,_wrap_QueryEnvironment_fieldList,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentcount,_wrap_QueryEnvironment_documentCount,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(queryenvironment_onedocumentcount,_wrap_QueryEnvironment_onedocumentCount,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_expressioncount,_wrap_QueryEnvironment_expressionCount,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentexpressioncount,_wrap_QueryEnvironment_documentExpressionCount,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_expressionlist,_wrap_QueryEnvironment_expressionList,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_documentlength,_wrap_QueryEnvironment_documentLength,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_setformulationparameters,_wrap_QueryEnvironment_setFormulationParameters,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(queryenvironment_reformulatequery,_wrap_QueryEnvironment_reformulateQuery,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(new_queryenvironment,_wrap_new_QueryEnvironment,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(queryexpander_runexpandedquery,_wrap_QueryExpander_runExpandedQuery,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(queryexpander_expand,_wrap_QueryExpander_expand,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(new_rmexpander,_wrap_new_RMExpander,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(rmexpander_expand,_wrap_RMExpander_expand,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(new_ponteexpander,_wrap_new_PonteExpander,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(ponteexpander_expand,_wrap_PonteExpander_expand,swig_arginfo_000)
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(libindri_php, libindri_php_init_globals, NULL);
...
le_swig__p_std__vectorT_indri__api__ScoredExtentResult_t=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, (char *)SWIGTYPE_p_std__vectorT_indri__api__ScoredExtentResult_t->name, module_number);
...
le_swig__p_std__vectorT_lemur__api__DOCID_T_t=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, (char *)SWIGTYPE_p_std__vectorT_lemur__api__DOCID_T_t->name, module_number);
...
le_swig__p_std__vectorT_std__string_t=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, (char *)SWIGTYPE_p_std__vectorT_std__string_t->name, module_number);

...
public class QueryEnvironment {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        indri_goJNI.delete_QueryEnvironment(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public QueryEnvironment() {
    this(indri_goJNI.new_QueryEnvironment(), true);
  }
...
public void addServer(String hostname) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_addServer(swigCPtr, this, hostname);
  }
...
public void addIndex(String pathname) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_addIndex(swigCPtr, this, pathname);
  }
...
public void removeServer(String hostname) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_removeServer(swigCPtr, this, hostname);
  }
...
public void removeIndex(String pathname) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_removeIndex(swigCPtr, this, pathname);
  }
...
public void close() throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_close(swigCPtr, this);
  }
...
public void setMemory(long memory) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_setMemory(swigCPtr, this, memory);
  }
...
public void setScoringRules(String[] rules) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_setScoringRules(swigCPtr, this, rules);
  }
...
public void setStopwords(String[] stopwords) throws java.lang.Exception {
    indri_goJNI.QueryEnvironment_setStopwords(swigCPtr, this, stopwords);
  }
...
public ScoredExtentResult[] runQuery(String query, int resultsRequested) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_runQuery__SWIG_0(swigCPtr, this, query, resultsRequested);
}
...
public ScoredExtentResult[] runQuery(String query, int[] documentSet, int resultsRequested) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_runQuery__SWIG_1(swigCPtr, this, query, documentSet, resultsRequested);
}
...
public QueryResults runQuery(QueryRequest request) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_runQuery__SWIG_2(swigCPtr, this, request);
}
...
public QueryAnnotation runAnnotatedQuery(String query, int resultsRequested) throws java.lang.Exception {
    long cPtr = indri_goJNI.QueryEnvironment_runAnnotatedQuery__SWIG_0(swigCPtr, this, query, resultsRequested);
...
public QueryAnnotation runAnnotatedQuery(String query, int[] documentSet, int resultsRequested) throws java.lang.Exception {
    long cPtr = indri_goJNI.QueryEnvironment_runAnnotatedQuery__SWIG_1(swigCPtr, this, query, documentSet, resultsRequested);
    return (cPtr == 0) ? null : new QueryAnnotation(cPtr, true);
  }
...
public ParsedDocument[] documents(int[] documentIDs) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documents__SWIG_0(swigCPtr, this, documentIDs);
}
...
public ParsedDocument[] documents(ScoredExtentResult[] results) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documents__SWIG_1(swigCPtr, this, results);
}
...
public String[] documentMetadata(int[] documentIDs, String attributeName) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documentMetadata__SWIG_0(swigCPtr, this, documentIDs, attributeName);
}
...
public String[] documentMetadata(ScoredExtentResult[] documentIDs, String attributeName) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documentMetadata__SWIG_1(swigCPtr, this, documentIDs, attributeName);
}
...
public int[] documentIDsFromMetadata(String attributeName, String[] attributeValue) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documentIDsFromMetadata(swigCPtr, this, attributeName, attributeValue);
}
...
public ParsedDocument[] documentsFromMetadata(String attributeName, String[] attributeValue) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documentsFromMetadata(swigCPtr, this, attributeName, attributeValue);
}
...
public long termCount() throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_termCount__SWIG_0(swigCPtr, this);
  }
...
public long termCount(String term) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_termCount__SWIG_1(swigCPtr, this, term);
  }
...
public long termFieldCount(String term, String field) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_termFieldCount(swigCPtr, this, term, field);
  }
...
public String[] fieldList() throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_fieldList(swigCPtr, this);
}
...
public long documentCount() throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_documentCount__SWIG_0(swigCPtr, this);
  }
...
public long documentCount(String term) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_documentCount__SWIG_1(swigCPtr, this, term);
  }
...
public DocumentVector[] documentVectors(int[] documentIDs) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_documentVectors(swigCPtr, this, documentIDs);
}
...
public double expressionCount(String expression, String queryType) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_expressionCount__SWIG_0(swigCPtr, this, expression, queryType);
  }
...
public double expressionCount(String expression) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_expressionCount__SWIG_1(swigCPtr, this, expression);
  }
...
public double documentExpressionCount(String expression, String queryType) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_documentExpressionCount__SWIG_0(swigCPtr, this, expression, queryType);
  }
...
public double documentExpressionCount(String expression) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_documentExpressionCount__SWIG_1(swigCPtr, this, expression);
  }
...
public ScoredExtentResult[] expressionList(String expression, String queryType) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_expressionList__SWIG_0(swigCPtr, this, expression, queryType);
}
...
public ScoredExtentResult[] expressionList(String expression) throws java.lang.Exception {
  return indri_goJNI.QueryEnvironment_expressionList__SWIG_1(swigCPtr, this, expression);
}
...
public int documentLength(int documentID) throws java.lang.Exception {
    return indri_goJNI.QueryEnvironment_documentLength(swigCPtr, this, documentID);
  }
...
public void setFormulationParameters(Map p) {
    indri_goJNI.QueryEnvironment_setFormulationParameters(swigCPtr, this, p);
  }
...
public String reformulateQuery(String query) {
    return indri_goJNI.QueryEnvironment_reformulateQuery(swigCPtr, this, query);
  }
...
public String stemTerm(String term) {
    return indri_goJNI.QueryEnvironment_stemTerm(swigCPtr, this, term);
  }
...
public long termCountUnique() {
    return indri_goJNI.QueryEnvironment_termCountUnique(swigCPtr, this);
  }
...
public long stemCount(String term) {
    return indri_goJNI.QueryEnvironment_stemCount(swigCPtr, this, term);
  }
...
public long stemFieldCount(String term, String field) {
    return indri_goJNI.QueryEnvironment_stemFieldCount(swigCPtr, this, term, field);
  }
...
public long documentStemCount(String stem) {
    return indri_goJNI.QueryEnvironment_documentStemCount(swigCPtr, this, stem);
  }

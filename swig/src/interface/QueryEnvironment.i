...
namespace indri {
  namespace api {
    ...
    setEx(QueryEnvironment::documentsFromMetadata);
    setEx(QueryEnvironment::termCount);
    setEx(QueryEnvironment::termFieldCount);
    setEx(QueryEnvironment::fieldList);
    setEx(QueryEnvironment::documentCount);
    setEx(QueryEnvironment::documentVectors);
    setEx(QueryEnvironment::expressionCount);
    setEx(QueryEnvironment::documentExpressionCount);
    setEx(QueryEnvironment::expressionList);
    setEx(QueryEnvironment::documentLength);
